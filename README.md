...
16. `main` - Основная функция программы для работы с банковскими транзакциями.
...
12. test_load_transactions_csv.py - тестирование `load_transactions_csv`
13. test_load_transactions_xlsx.py - тестирование `load_transactions_xlsx`
14. test_search.py - тестируем `search`
...
- main.log - сообщения по модулю main
